...
#define     DELETE_HASH                 @"deleteHash"
#define     DETAILS_FOR_MOBIL_SDK       @"detailsForMobileSdk"
#define     EDIT_USER_CARD_HASH         @"editUserCardHash"
#define     GET_USER_CAR_HASH           @"getUserCardHash"
#define     MOBIL_SDK                   @"mobileSdk"
#define     PAYMENT_HASH                @"paymentHash"
...
//Damn! why this is being use, only god knows.
